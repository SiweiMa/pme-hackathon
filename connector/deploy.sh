#!/usr/bin/env bash
# deploy.sh — Build, push, and update the PME Federated Connector container image.
#
# Usage:
#   ./connector/deploy.sh          (run from repo root)
#
# Prerequisites:
#   - Docker running
#   - AWS CLI configured with credentials
#   - ECR repository created via Terraform (infra/federated.tf)
#   - Lambda function created via Terraform (infra/federated.tf)
...
echo "=== PME Federated Connector Deploy ==="
